...
const DashboardLayout = async ({ children }: { children: React.ReactNode }) => {
  ...
  const {adminNotifications, reports} = await getDashboardDataCount();
  ...
  return (
    <div className="flex max-h-screen overflow-hidden fixed w-full">
      <Aside len_reports_unread={len_reports_unread} len_notifications_unread={len_notifications_unread} />
