        ...
        <div className="container mx-auto p-12">
            ...
            <div className='w-xl md:w-[70%] mx-auto my-24'>
                ...
                <section className="mb-4">
                    ...
                    <p>
                        Le réseau social Hobbies est un service en ligne exploité par [Nom de l'entreprise], une société enregistrée en [Pays] sous le numéro [Numéro d'enregistrement], dont le siège social est situé à [Adresse]. En utilisant le réseau social Hobbies, vous acceptez d'être lié par ces CGU.
                    </p>
                </section>
                ...
                <section className="mb-4">
                    ...
                    <p>
                        Les utilisateurs du réseau social Hobbies sont responsables du contenu qu'ils publient. Le contenu publié doit respecter les lois et règlements en vigueur en [Pays], ainsi que les droits de tiers.
                    </p>
                    <p>
                ...
                <section className="mb-4">
                    ...
                    <p>
                        Vous disposez d'un droit d'accès, de rectification, d'opposition et de suppression de vos données personnelles. Pour exercer ces droits, veuillez nous contacter à l'adresse e-mail suivante : [Adresse e-mail de contact].
                    </p>
                </section>
            </div>
        </div>
