            ...
            <div className="w-[140px] h-[200px] shadow-md rounded-[7px] bg-gray-800 flex flex-col overflow-hidden">
                ...
                <div className='flex-1 w-full items-center justify-center flex flex-col'>
                    <div className="flex justify-center min-h-[50%] w-full relative">
                        <div className="absolute w-[50px] h-[50px] bg-gray-800 outline outline-1 outline-zinc-500 -translate-y-1/2 rounded-full text-sm flex items-center justify-center">
                            <Icons.add />
                        </div>
                    </div>
